...
const root = (0, module_root_sync.default)(__dirname$2);
function spawn(cmd, args, options, cb) {
	const cwd = options.cwd || process.cwd();
	const env = options.env || process.env;
	const pathKey = (0, env_path_key.default)(env) || "";
	let envPath = env[pathKey] || "";
	envPath = (0, path_string_prepend.default)(envPath, path.default.resolve(cwd, "node_modules", ".bin"));
	envPath = (0, path_string_prepend.default)(envPath, path.default.resolve(root, "..", ".bin"));
